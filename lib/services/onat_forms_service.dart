...
class OnatFormsService {
  ...
  static Future<void> generateDj01(String period) async {
    ...
    // Tasas simplificadas (ajustables)
    const incomeTaxRate = 0.05; // 5% sobre utilidad
    const socialSecurityRate = 0.02; // 2% sobre ingresos brutos
  ...
  /// Genera el PDF del formulario DJ-02 (Declaración de Empleadores) - simplificado.
  static Future<void> generateDj02(String period) async {
    ...
    // Cantidad de trabajadores únicos en el período (simplificado)
