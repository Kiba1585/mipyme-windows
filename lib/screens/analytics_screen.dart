                    ...
                    child: PieChart(
                      PieChartData(
                        sections: _expensesByCategory.map((cat) {
                          final total = _expensesByCategory.fold(0.0, (sum, e) => sum + e.amount);
                  ...
                  Wrap(
                    ...
                    children: _expensesByCategory.map((cat) {
                      return Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Container(width: 12, height: 12, color: _getCategoryColor(cat.category)),
                            ...
                            sideTitles: SideTitles(
                              ...
                              getTitlesWidget: (value, meta) {
                                ...
                                if (index >= 0 && index < _monthlyTrends.length) {
                                  return Text(_monthlyTrends[index].month.substring(5),
