...
class _PayrollScreenState extends State<PayrollScreen> {
  ...
  Future<void> _addEmployee() async {
    ...
    await DatabaseService.addEmployee(
        Employee(name: _nameCtrl.text.trim(), baseSalary: double.parse(_salaryCtrl.text)));
    _nameCtrl.clear();
    _salaryCtrl.clear();
    _load();
  }
  ...
  Future<void> _payEmployee(Employee emp) async {
    ...
    await DatabaseService.addFinancialRecord(
      ...
      category: 'Nómina',
      description:
          '${emp.name}: Base \$${emp.baseSalary} + Bono \$${bonus} - Deduc. \$${deduction}',
    );
    _bonusCtrl.text = '0';
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                        labelText: 'Nombre empleado', border: OutlineInputBorder()),
                  ),
                  ...
                  ..._payrollHistory.map((r) => ListTile(
                        title:
